...
<body>
    ...
    <main class="product-main">
        ...
        <h1 class="titelklacht">What do you think about our staff?</h1>


        <form class="klachtform" id="comform" method="post" action="pers-feedbackresult.php">
            ...
            <section class="radiofeed-btn">
                <label name="feedradio">How do you experience our support?</label>
               ...
               amazing<input type="radio" name="feedradio" value="amazing">
            </section>

            <p>Is there anything else you would like to say?.</p>

            <textarea form="comform" name="comment" placeholder="More feedback here.. " required rows="4"
                cols="50"></textarea>
