...
<body>
    ...
    <main class="product-main">
     ...
     $query = $db->prepare("SELECT * FROM products WHERE productID = '20'");
     $query->execute();
    ...
    ?>
        ...
        <p class="beschrijving">
            Deze HP Victus 16-e0300nd gaming laptop is geschikt voor de instap gamer.<br>
            Je speelt zo nu en dan wel eens Minecraft of FIFA 2021, maar alles op de allerhoogste grafische instellingen
            spelen vind je niet zo belangrijk.<br>
            De CPU's van AMD beschikken over bijzonder veel cores en threads, waardoor ze enorm efficiënt zijn bij het
            uitvoeren van zowel meerdere-<br>
            processen tegelijkertijd als zware enkelvoudige taken op je laptop. Perfect voor de ware multi-tasker
            dus.<br>
